            ...
            <div class="col">
                <div class="card text-white">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                        <?php
                        $messagesrecus1=getAllMessageReceivedByUserId($_SESSION["id_user"]);
                        foreach ($messagesrecus1 as $k=>$v) {
                            ...
                            ?>
                                ...
                                <td>Le <?=$v["datesend"] ?></td>
                                <td>
                                    <a class="btn btn-danger" href="delmsg.php?id=<?=$v["idmessage"] ?>">
                                        <span class="fa fa-trash"></span>
                                    </button>
                                    <a href="detail.php?id=<?=$v["idmessage"] ?>" class="btn btn-success">
